...
parser.add_option("--edges", "-e", default=16, help="Number of graph edges", type="int")
...
def dumpTextOutput(options, node_list):
    ...
    print "Printing %s graph to: %s" % (options.character, out_filename)
    outfile = open(out_filename, "w")

    print >>outfile, options.nodes
    accumulate_edges = 0
